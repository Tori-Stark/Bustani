...
<?php $__env->startSection('body'); ?>
    ...
    <div class="col-lg-10 col-lg-offset-1" style="margin-top: 100px; margin-left: 40px;">
            ...
            <table id = "datatable" class="table table-bordered table-striped table-green">
                ...
                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('roles.edit', $role->id)); ?>" class="btn btn-dark pull-left" style="margin-right: 3px;">Edit</a>
        ...
        <a href="<?php echo e(URL::to('admin/roles/create')); ?>" class="btn btn-success">Add Role</a>
...
<?php echo $__env->make('admin.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jah/Desktop/Bustani/resources/views/roles/index.blade.php ENDPATH**/ ?>