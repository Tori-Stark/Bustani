          ...
          <div class="container">
              <div class="row">
                  <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(assets/images/about.jpg);">
                      <a href="https://www.pexels.com/video/woman-picking-vegetables-at-the-market-6272873/" class="icon popup-vimeo d-flex justify-content-center align-items-center">
                ...
                <div class="ml-md-0">
                 <h2 class="mb-4">Welcome to Bustani</h2>
              </div>
            </div>
            
            <div class="pb-md-5">
                <p>Bustani has been bridging gaps in food and market security through an organised platform for an efﬁcient, fair, transparent and formal marketplace.</p>
                          <p>We connect you to farmers and producers who deliver fresh and quality produce. From the thousands of sellers on our platfrom, you shall get all of your produce needs at fair prices.</p>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\gudle\OneDrive\Desktop\web-applications\Bustani\resources\views/about.blade.php ENDPATH**/ ?>